...
XYZToTextFiles<-function(home_dir, lake_name, WSEL, dam_elev){
  ...
  if(dir.exists(adcp_path)){
    setwd(adcp_path)
    i=1
    ls=list.files(pattern="ADCP.csv$")
    for(i in 1:length(ls)){
...
LidarToTextFiles <- function(home_dir, lake_name, WSEL, dam_elev){
  ...
  setwd(lidar_path)
  ls=list.files(lidar_path,pattern=(".las|.laz"))
  ...
  if(length(ls)!=0){
    ...
    for(i in 1:length(ls)){
      ...
      utm15crs <- crs("+proj=utm +zone=15 +units=m +datum=NAD83 +no_defs")
...
XYZToTextFiles(home_dir = "E:/HYPACK_Projects/2020_DNR_Lakes/2020-07_GardenCityOld",
                                 lake_name = "GardenCityOld",
                                 WSEL =271.74,
                                 dam_elev =271.874)

LidarToTextFiles(home_dir = "E:/HYPACK_Projects/2020_DNR_Lakes/2020-07_GardenCityOld",
                                 lake_name = "GardenCityOld",
                                 WSEL =271.74,
                                 dam_elev =271.874)

XCheckToTextFiles(home_dir = "E:/HYPACK_Projects/2020_DNR_Lakes/2020-07_GardenCityOld",
                                 lake_name = "GardenCityOld")
